...
/*****************************IO mode config**************************************/  
    ...
    GPIO_InitStructure.GPIO_OType = GPIO_OType_OD;//OD MUST BE SET
    ...
    if(TIMx == TIM1)
    {
        ...
        else if( GPIO_AF == 1 )
        {
            ...
            GPIO_PinAFConfig(GPIOE, GPIO_PinSource14, GPIO_AF_TIM1);
				...
				else if(TIMx == TIM3)//this TIM doesn't have GPIO_AF==1 
    {
        ...
        if( GPIO_AF == 0 )
        {
            ...
            GPIO_InitStructure.GPIO_Pin =   GPIO_Pin_8 |GPIO_Pin_9;//ENABLE CH3&CH4
   ...
   // TIM_TimeBaseStructure.TIM_RepetitionCounter = 0;
    TIM_TimeBaseInit(TIMx, &TIM_TimeBaseStructure);//TIM basic init
    
    TIM_OCInitStructure.TIM_OCMode = TIM_OCMode_PWM1;
    TIM_OCInitStructure.TIM_OutputState = TIM_OutputState_Enable;
   // TIM_OCInitStructure.TIM_OutputNState = TIM_OutputNState_Disable;
		
		if(TIMx==TIM3)TIM_OCInitStructure.TIM_Pulse = (Period+1)/2;
    else TIM_OCInitStructure.TIM_Pulse = 0;
...
void HF_PWM_Set_State(TIM_TypeDef* TIMx,uint8_t state)//0 enable 1 disable
{
	if(state==0)TIM_Cmd(TIMx, ENABLE);
	if(state==1)TIM_Cmd(TIMx, DISABLE);
}
